...
<p> Endpoint que leva os incidentes cadastrados: /incidentes </p>      
...
const db = await criarBanco() //Chamamos a função do outro arquivo. O await é o "aguarde", pois o banco precisa de um tempo para abrir 
